...
tags:
  ...
  - 内存泄漏
  - API
excerpt: "整理内存操作相关的基础知识：malloc/free 的工作方式、size_t、多分配内存的用途、常见内存错误、不同语言的内存管理，以及 API 概念。"
toc: true
toc_label: "目录"
toc_icon: "list"
toc_sticky: true
...
> **适合人群**：正在学习 C/C++ 内存管理，想系统理解 `malloc`/`free`、内存错误和 API 概念的读者。
{: .notice--info}
